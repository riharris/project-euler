...
7 5 9";
    ...
    const PROBLEM_GRID = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48";
    ...
    {
        $this->assertSame('72', strval(new GreatestProductOfAdjacentNumbersOfLengthFor(1, self::TEST_GRID)));
    }

    public function testConfirmOutputMatchesUnknownResult()
    {
        $this->markTestSkipped('Solution for problem 11');
        
        $this->assertSame('70600674', strval(new GreatestProductOfAdjacentNumbersOfLengthFor(3, self::PROBLEM_GRID)));
    }
}