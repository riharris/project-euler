...
class ProblemTwoTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame(4613732, $this->sum((new FibonacciSequence(1, 4000000))->forValuesMatching(array(
            $this,
            'isEvenAndLessThanFourMillion'
        ))));
    }

    function isEvenAndLessThanFourMillion($i)
    {
